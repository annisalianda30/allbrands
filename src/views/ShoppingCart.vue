                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="cart-pic first-row">
                                                <img src="img/cart-page/hoodie1.jpg" />
                                            </td>
                                            <td class="cart-title first-row text-center">
                                                <h5>Cropped Sweatshirt Stradivarius</h5>
                                            </td>
                                            <td class="p-price first-row">IDR 370.000</td>
                                        ...
                                        <tr>
                                            <td class="cart-pic first-row">
                                                <img src="img/cart-page/Slingbag1.jpg" />
                                            </td>
                                            <td class="cart-title first-row text-center">
                                                <h5>Buckled cross-body bag</h5>
                                            </td>
                                            <td class="p-price first-row">IDR 350.000</td>
                                            <td class="delete-item"><a href="#"><i class="material-icons">
                                              close
                                              </i></a></td>
                                        </tr>
                        ...
                        <div class="col-lg-12">
                            <div class="proceed-checkout text-left">
                                <ul>
                                    ...
                                    <li class="subtotal mt-3">No. Rekening <span>0618022208</span></li>
                                    <li class="subtotal mt-3">Nama Penerima <span>Annisa</span></li>
                                </ul>
...
<script>
import HeaderAllbrands from '@/components/HeaderAllbrands.vue'
    export default {
        name: "Cart",
        components: {
            HeaderAllbrands
